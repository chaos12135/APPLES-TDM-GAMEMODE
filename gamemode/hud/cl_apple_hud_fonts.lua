...
surface.CreateFont( "DebugFixed2",
    {
		font      = "DebugFixed",
	--	size      = 16,
	--	weight    = 900,
...
surface.CreateFont( "TDM_Ammo_Primary",
    {
        font      = "MenuLarge",
        size      = 26,
        weight    = 200,
...
surface.CreateFont( "TDM_Ammo_Secondary",
    {
        font      = "HUDNumber",
        size      = 73,
        weight    = 200,
